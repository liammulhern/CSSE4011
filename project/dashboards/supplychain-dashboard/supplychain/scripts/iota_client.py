...
def iota_build_and_post_block(productevent: ProductEvent) -> Tuple[HexStr, Block]:
    """
    ...
    idx_hex = utf8_to_hex(productevent.message_id)
    data_hex: HexStr = productevent.compute_hash()
...
def iota_get_block_data(product_event: ProductEvent) -> Tuple[str, HexStr]:
    """
    ...
    block: Block = iota_client.get_block_data(product_event.message_id)
