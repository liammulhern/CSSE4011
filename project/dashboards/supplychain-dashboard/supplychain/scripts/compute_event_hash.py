...
def compute_tracker_hash(payload: dict) -> str:
    # pull out the *string* values exactly as C printed them:
    ...
    # rebuild the exact same snippet that C’s snprintf wrote:
    snippet = (
        f'"payload":{{'
          f'"timestamp":"{ts}",'
          f'"uptime":"{up}",'
    ...
    # turn it into bytes and pad out to 1024 bytes with NULs
